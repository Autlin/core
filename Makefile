...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/Autlin/core/constant.Version=$(VERSION)" \
		-X "github.com/Autlin/core/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
